    ...
    <div class="container-fluid containerx">
        <div class="containery">
            <div class="form_area">
                ...
                <form action="http://localhost/chat2/case-2-javascript-ajax/index.php/controller/login" method="post">
                    ...
                    <div class="form_group">
                        ...
                        <input placeholder="password" id="email" name="password" class="form_style" type="Password">
                    </div>
                    <div>
            ...
            <p class="text-center">Don't have an account? <a href="register"><span class="span">Register</span></a></p>
